...
func TestFWFileringDnsApplicationGroups(t *testing.T) {
	...
	group := DnsApplicationGroup{
		Name:        name,
		Description: name,
		DnsApplications: []string{"RACKSPACE", "MCAFEE", "SOPHOS", "BRIGHTSPCACE",
			"CSWG",
			"SALESFORCE_DNSTUN",
			"INTECH",
			"SECURESERVER",
	...
	var createdResource *DnsApplicationGroup
	...
	retrievedResource.DnsApplications = group.DnsApplications
...
func tryRetrieveResource(s *zscaler.Service, id int) (*DnsApplicationGroup, error) {
	var resource *DnsApplicationGroup
	var err error
...
func TestUpdateNonExistentResource(t *testing.T) {
	...
	_, err = Update(context.Background(), service, 0, &DnsApplicationGroup{})
	if err == nil {
