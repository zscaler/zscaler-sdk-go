...
func TestTagGroupCRUD(t *testing.T) {
	...
	createdResource, _, err := Create(context.Background(), service, TagGroup{
		Name:        name,
		Description: name,
	})
	if err != nil {
...
func TestUpdateNonExistentResource(t *testing.T) {
	...
	_, err = Update(context.Background(), service, "non_existent_id", &TagGroup{})
	if err == nil {
