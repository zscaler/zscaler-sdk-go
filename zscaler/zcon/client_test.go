...
func TestNewClient(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantC: &Client{
				URL:       fmt.Sprintf("https://admin.%s.net/%s", "zspreview", zconAPIVersion),
				userName:  "userName",
				password:  "password",
				apiKey:    "apiKey",
				UserAgent: "UserAgent",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			gotC, err := NewClient(tt.args.userName, tt.args.password, tt.args.apiKey, tt.args.zconCloud, tt.args.UserAgent)
			if err != nil {
