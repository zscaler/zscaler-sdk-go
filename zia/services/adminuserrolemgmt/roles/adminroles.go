...
func (service *Service) GetAPIRole(apiRole, includeApiRole string) (*AdminRoles, error) {
...
func (service *Service) GetAuditorRole(auditorRole, includeAuditorRole string) (*AdminRoles, error) {
...
func (service *Service) GetPartnerRole(partnerRole, includePartnerRole string) (*AdminRoles, error) {
